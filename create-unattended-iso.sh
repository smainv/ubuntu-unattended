...
if [ $ub1604 == "yes" ]; then
   late_command="apt-install wget; in-target wget --no-check-certificate -O /home/$username/start.sh https://github.com/smainv/ubuntu-unattended/raw/master/start.sh ;\
     in-target chmod +x /home/$username/start.sh ;"
else 
   late_command="chroot /target wget -O /home/$username/start.sh https://github.com/smainv/ubuntu-unattended/raw/master/start.sh ;\
